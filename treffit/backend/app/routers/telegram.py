...
WELCOME = (
    ...
    "Ответьте на шесть коротких вопросов, листайте анкеты, а фото "
    "собеседника откроется, когда вы напишете ему три сообщения."
)

HELP = (
    "<b>Как устроен Treffit</b>\n\n"
    "• <b>Поиск</b> — свайп вправо, если нравится, влево — мимо.\n"
    "• <b>Карты</b> — потрите карту, чтобы увидеть, кто под ней.\n"
