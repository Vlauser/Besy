        ...
        'meta' => [
            ...
            'fieldsets' => [
                [
                    ...
                    'fields' => ['seo.og_image', 'seo.favicon', 'seo.apple_icon'],
                ],
                [
                    'title'  => 'Главная — /',
            ...
            'fields' => [
                ...
                'seo.favicon'  => ['label' => 'Значок сайта во вкладке', 'type' => 'image', 'hint' => 'Квадратная картинка, лучше 512×512 PNG или SVG. Проверяйте, как она читается в 16 пикселей.'],
                'seo.apple_icon' => ['label' => 'Значок на домашнем экране телефона', 'type' => 'image', 'hides' => 'значок', 'hint' => 'PNG 180×180 без прозрачности — iOS зальёт прозрачное чёрным. Пусто — телефон возьмёт значок вкладки, но качество будет хуже.'],
